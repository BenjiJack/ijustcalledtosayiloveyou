...
require 'twilio-ruby'
  ...
  def create
	...
	@call = @client.account.calls.create(
		...
		#</Response>
  		:url => "http://twimlets.com/echo?Twiml=%3CResponse%3E%0A%3CSay%20voice%3D%22woman%22%3EHi%20" + @user[:recipientname] + "%2C%20" + @user[:sendername] + "%20has%20a%20message%20for%20you!%3C%2FSay%3E%0A%3CPlay%3Ehttp%3A%2F%2Fagile-beach-2909.herokuapp.com%2Fijustcalled.mp3%3C%2FPlay%3E%0A%3CSay%20voice%3D%22woman%22%3EI%20just%20called%20to%20say%20I%20love%20you%20dot%20com%3C%2FSay%3E%0A%3C%2FResponse%3E&"
